...
validate <- cbind(prediction_output_long, diff_base_temp$temp_for_model_C, diff_base_temp$ch4_diff %>%
  summarise(NSE = NSE(mean, `diff_base_temp$ch4_ebu`),
            rmse = rmse(mean, `diff_base_temp$ch4_ebu`))
